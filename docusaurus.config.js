...
const config = {
  title: 'Sex Toy Protocols I Have Known And Loved (STPIHKAL)',
  staticDirectories: ['examples', 'static'],
  tagline: 'Protocol documentation for various intimate devices and file formats.',
  url: 'https://stpihkal.docs.buttplug.io',
  baseUrl: '/',
  onBrokenLinks: 'throw',
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          {
            href: 'https://github.com/buttplugio/stpihkal',
            label: 'GitHub',
            position: 'right',
          },
        ],
